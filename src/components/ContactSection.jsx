      ...
      <div className="container mx-auto max-w-5xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          ...
          <div className="space-y-8">
            ...
            <div className="pt-8">
              ...
              <div className="flex space-x-4">
                <a href="https://www.linkedin.com/in/om-singh-476402179/" target="_blank" rel="noreferrer">
                  <Linkedin />
                </a>
                <a href="https://x.com/omsingh8400" target="_blank" rel="noreferrer">
                  <Twitter />
                </a>
                <a href="https://www.instagram.com/om.__.singh/" target="_blank" rel="noreferrer">
                  <Instagram />
                </a>
          ...
          <div className="bg-card p-8 rounded-lg shadow-xs">
            ...
            <form
              action="https://formspree.io/f/xanlppdz"
              method="POST"
              className="space-y-6"
            >
              <div>
